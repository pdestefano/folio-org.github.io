...
[collaboration tools](/guidelines/communityguidelines/).
...
Add [.editorconfig](/guidelines/codingconventions/#style-guidelines-and-configuration) file.

Add initial NEWS.md or CHANGELOG.md file.

If necessary, add a basic .gitignore file.
Developers will have [their own](/guidelines/codingconventions/) ~/.gitignore_global to handle most.
...
- [raml](https://github.com/folio-org/raml)
  ...
  The [API reference](/reference/refinfo) documentation is also
  generated.
